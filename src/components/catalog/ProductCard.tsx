...
export default function ProductCard({
  ...
  return (
    <article className="product-card group overflow-hidden rounded-card border border-pava-brown/8 bg-white transition-all duration-350 hover:-translate-y-1 hover:shadow-[var(--shadow-card-hover)]">
      {/* Image area */}
      <div
