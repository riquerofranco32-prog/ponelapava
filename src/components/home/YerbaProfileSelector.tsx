...
const YERBA_PROFILES: YerbaProfile[] = [
  {
    ...
    featuredProduct: {
      ...
      product: {
        ...
        description: "Yerba suave y seleccionada con bajo contenido de polvo.",
        price: 4900,
        category: "yerbas",
        status: "available",
        stock: 50,
        images: ["/products/yerba-playadito-1kg.jpg"],
        brand: "Playadito",
      },
    },
  },
  {
    ...
    featuredProduct: {
      ...
      product: {
        ...
        description: "Yerba uruguaya pura hoja sin palo con gran rendimiento.",
        price: 6800,
        category: "yerbas",
        status: "available",
        stock: 45,
        images: ["/products/yerba-canarias-1kg.jpg"],
        brand: "Canarias",
      },
    },
  },
  {
    ...
    featuredProduct: {
      name: "Yerba Mate Sara Extra Suave",
      brand: "Sara",
      weight: "1kg",
      price: 6400,
      ...
      product: {
        id: "yerba-sara-1kg",
        name: "Yerba Mate Sara Extra Suave 1kg",
        slug: "yerba-mate-sara-1kg",
        description: "Blend equilibrado con estacionamiento prolongado.",
        price: 6400,
        category: "yerbas",
        status: "available",
        stock: 30,
        images: ["/products/yerba-sara-1kg.jpg"],
        brand: "Sara",
      },
    },
  },
  {
    ...
    featuredProduct: {
      name: "Yerba Mate Sara Tradicional",
      brand: "Sara",
      weight: "1kg",
      price: 6400,
      image: "/products/yerba-sara-1kg.jpg",
      product: {
        id: "yerba-sara-1kg",
        name: "Yerba Mate Sara Tradicional 1kg",
        slug: "yerba-mate-sara-1kg",
        description: "Yerba de molienda tradicional con carácter y cuerpo.",
        price: 6400,
        category: "yerbas",
        status: "available",
        stock: 25,
