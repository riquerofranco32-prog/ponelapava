...
const variantClasses: Record<string, string> = {
  ...
  out_of_stock:
    "bg-pava-terracotta/10 text-pava-terracotta border border-pava-terracotta/20",
  featured: "bg-pava-gold text-pava-brown border border-pava-gold",
  category:
    "bg-pava-cream-dark text-pava-brown-mid border border-pava-brown/10",
  low_stock:
    "bg-pava-gold-deep/10 text-pava-gold-deep border border-pava-gold-deep/25",
  custom: "",
};
